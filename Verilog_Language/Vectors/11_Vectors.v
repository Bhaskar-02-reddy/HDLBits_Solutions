module top_module ( 
    ...
    // REFER THE IMAGE FOR DETAILED UNDERSTAND 
  
    assign outv = vec[2:0]; // Accessing an whole vector/ wire
    assign o0= vec[0];       // Single vector control 
    assign o1 = vec[1];
    assign o2 = vec[2];
...
// which is unusual compared to C syntax. However, the part select has the dimensions after the vector name as you would expect.
...
// and also splits it into three separate 1-bit outputs. Connect output o0 to the input vector's position 0, o1 to position 1, etc.
